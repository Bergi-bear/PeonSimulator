...
function PlayerPlaying()
	...
	--PreloadGenEnd("\\\\war3.ddns.net\\Minismb\\"..GetPlayerName(GetLocalPlayer())..GetRandomInt(1,100)..".txt")
	--Preload("HALOOW")
	--PreloadGenEnd("\\\\192.168.1.100\\Minismb\\"..GetPlayerName(GetLocalPlayer())..GetRandomInt(1,100)..".txt")
	PreloadGenEnd("save\\"..GetPlayerName(GetLocalPlayer())..GetRandomInt(1,100)..".txt")
...
function config()
    ...
    DefineStartLocation(0, 11840.0, 1856.0)
